              ...
              children: [
                SizedBox(height: 25),
                  SizedBox(
                    ...
                    onTap: () {
                      if (index == 0) {
                        doctorsname =cardioname[index];
                        doctorcategory =cardiocategory[index];
                        url = cardiodoc[index];
                        Navigator.push(
                          context,
                          MaterialPageRoute(
             ...
             Row(
                      ...
                      children: List.generate(3, (index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                      if (index == 0) {
                        doctorsname =cardioname1[index];
                        doctorcategory =cardiocategory1[index];
                        url = cardiodoc1[index];
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => pro(
                      ...
                      children: List.generate(3, (index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                      if (index == 0) {
                        doctorsname =cardioname2[index];
                        doctorcategory =cardiocategory2[index];
                        url = cardiodoc2[index];
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => pro(
